...
# os.system("srun main dgemm6_ijk2 2048 36")
# os.system("srun main dgemm6_ikj2 2048 36")
# os.system("srun main dgemm6_jik2 2048 36")
# os.system("srun main dgemm6_jki2 2048 36")
# os.system("srun main dgemm6_kij2 2048 36")
# os.system("srun main dgemm6_kji2 2048 36")
# os.system("srun main dgemm7 2048 36")
# for i in range(0,4):
